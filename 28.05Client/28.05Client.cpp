#define WIN32_LEAN_AND_MEAN // Это макрос уменьшает размер заголовочных файлов Windows для оптимизации сборки.
#include <iostream> // Включаем заголовочный файл для ввода-вывода операций.
#include <Windows.h> // Включаем заголовочный файл для функций API Windows.
#include <WinSock2.h> // Включаем заголовочный файл для функций API Winsock.
#include <WS2tcpip.h> // Включаем заголовочный файл для структур и функций TCP/IP.
...
int main() {
    ...
    const char* sendBufferTwo = "How are you?"; // Второй буфер для отправляемых данных
